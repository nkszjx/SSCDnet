...
from deeplabv2_unsupervised import Deeplab_maxmin_model,Deeplab_maxmin_model_all
...
IMG_MEAN = np.array((62.00698793,58.66876762,58.67891434 ), dtype=np.float32)

DATASET = 'pascal_voc' # pascal_context

MODEL = 'deeplabv2' # deeeplabv2, deeplabv3p

DATA_DIRECTORY = '/home/Semisup_cloudSemSeg_master/dataset_test/'
DATA_LIST_PATH = '/home/Semisup_cloudSemSeg_master/dataset_test/landsat8_evaluation.txt'
...
RESTORE_FROM = './checkpoints_class_alignment/SSCDnet/VOC_35000.pth'



#RESTORE_FROM = './checkpoints/voc_semi_4sGAN_original_threshold_5/VOC_50000.pth'
#RESTORE_FROM = './checkpoints/voc_semi_4sGAN_original_1/VOC_50000.pth'
#RESTORE_FROM = './checkpoints/voc_semi_4sGAN_original_dcrf_2.5/VOC_50000.pth'


PRETRAINED_MODEL = None
SAVE_DIRECTORY = './results_L8_SSCDnet/'
...
def main():
    ...
    for index, batch in enumerate(testloader):
        ...
        size = size[0]
        with torch.no_grad():
             output, _, _, _, _ = model(Variable(image).cuda()) # model test 
